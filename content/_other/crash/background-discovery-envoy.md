...
* **Xenolinguist:** You can attempt to understand or communicate in an unknown language, even if it has no written fosrm, using gestures, tone, and intuition. Make an Intelligence (History) or Charisma (Persuasion) check to convey or comprehend meaning.
